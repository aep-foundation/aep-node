# Example - AEP Service on Fastify

A Fastify Service that mounts AEP routes and protects application routes with AEP client assertion JWTs. It advertises no grant types, so Agent examples use the JWT fallback mode.
