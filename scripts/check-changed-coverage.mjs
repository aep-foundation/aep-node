...
const lcovFiles = [
  "packages/adapters/express/coverage/lcov.info",
  "packages/adapters/fastify/coverage/lcov.info",
  "packages/adapters/hono/coverage/lcov.info",
  "packages/adapters/next/coverage/lcov.info",
  "packages/agent/coverage/lcov.info",
  "packages/conformance/coverage/lcov.info",
  "packages/core/coverage/lcov.info",
  "packages/extensions/service-policy/coverage/lcov.info",
  "packages/platform/coverage/lcov.info",
...
function readLcov(lcovFile, out, partialBranches) {
  ...
  if (!existsSync(absolute)) {
    throw new Error(
      `Missing coverage report: ${lcovFile}. Run pnpm test before pnpm coverage:changed.`
    );
  }
